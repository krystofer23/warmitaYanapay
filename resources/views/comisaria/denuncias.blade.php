...
<body>
            ...
            <div class="s-denuncia-bottom">
                <table class="default" style="width: 100%;">
                    ...
                    <tr style="width: 100%;" >
                        ...
                        <td>{{ $row->dni }}</td>
                        <td style="text-align: start !important;">{{ $row->descripcion }}</td>
    ...
    <section class="form-registro-no-usuarios none">
        <form action="{{ url('RegistroDenunciaPOST') }}" method="POST" enctype="multipart/form-data">
            ...
            <p style="color: #5c5c5c; padding-bottom: 20px">Para inicar la denuncia debe debe indicar los hechos como lo narra el denunciante.</p>
            @csrf
            ...
            <div class="inp-cont">
                <div>
                    ...
                    <br>
                    <input type="text" maxlength="8" name="id_victima" id="dni" placeholder="DNI" required>
                    <br>
                </div>
                <div class="ms-1">
            ...
            <br>
            <input name="file" class="form-control input-file" type="file" maxlength="9" name="celular" id="celular" placeholder="Celular">
            <br>
            <div class="cont-for-btn">
                <a href="{{ url('/Usuarios') }}">¿La victima no esta registrada?
                    <br> Registrela en la sección usuarios.</a>
