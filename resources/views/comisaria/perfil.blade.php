    ...
    <main>
        ...
        <section class="sec-denuncias" id="form-perfil">
            ...
            <div id="cont-forms">
                ...
                <form action="{{ url('EliminarComisaria') . '/' . $usuario_comisaria->id }}">
                    @csrf
                    @method('DELETE')
                    <span>Eliminar la cuenta de la comisaria</span>
                    <br>
                    <p style="color: #7f7f7f; padding-top: 2px;">Esta acción es permanente e irreversible. Perderás acceso a la cuenta y toda la información <br> que contiene.</p>
                    <br>
