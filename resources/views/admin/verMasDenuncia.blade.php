        ...
        <div class="border container-info-m-d" style="box-shadow: rgba(0, 0, 0, 0.1) 2px 2px 8px">
            ...
            <div class="d-flex w-100">
                ...
                <div class="w-100 p-4">
                    ...
                    <form action="{{ url('ActualizarDenunciaA') . '/' . $denuncia->id }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="w-100">
                            <span class="pb-2" style="font-size: 13px">Descripción</span>
                            <br>
                            <textarea name="descripcion" class="text-area" name="descripcion" id="" cols="10" rows="3">{{ $denuncia->descripcion }}</textarea>
                        </div>
                        <div class="w-100">
